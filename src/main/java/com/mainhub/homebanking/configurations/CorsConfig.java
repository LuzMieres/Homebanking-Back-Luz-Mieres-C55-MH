...
public class CorsConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList(new String[]{"http://localhost:8080", "http://localhost:5173", "https://homebanking-c55-mh-java-luz-romina-mieres.onrender.com", "https://homebanking-react-c55-mh-luzmieres.onrender.com"}));
